...
\setDocChangeRecord{%
  \addtohist{15d9cdc}{2018-04-30}{Unreleased draft.}{J.D.~Swinbank}
  \addtohist{1.0}{2018-04-30}{Approved in \jira{RFC-476}}{T~.Jenness}
}
...
\begin{itemize}
  ...
  available for test purposes (\jira{RFC-243})? How does it relate to other
